                ...
                >
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form class="smart-form" id="checkout-form" novalidate="novalidate" method="post" action="/user/modifyPassword">
                                <?php include __DIR__ . '/../include/msg.php'; ?>
                                <fieldset>
                                    <input type="hidden" name="id" value="<?php echo isset($id)?$id:0;?>">
                                    <input type="hidden" name="username" value="<?php echo isset($username)?$username:0;?>">
                                    <section>
                                        <label class="label">用户名</label>
                                        <label class="input">
                                            <input type="text" value="<?php echo isset($username)?$username:"" ?>"  disabled="disabled"  name="username11" maxlength="32" class="input-sm" placeholder="请输入用户名">
                                        </label>
                                    </section>
                                    <section>
